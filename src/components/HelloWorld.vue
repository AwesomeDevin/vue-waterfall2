...
<template>
  <div class="container-water-fall">
    ...
    <waterfall :col='col'   :data="data"   @loadmore="loadmore" :isLoading="loading" @scroll="scroll" @finish="finish" :height="'calc(100vh - 38px)'"  >
      <template >
      ...
      <!-- <template v-slot:footerLoading>自定义加载效果</template> -->
    </waterfall>
